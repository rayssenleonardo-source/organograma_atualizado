...
// ============================================================================
// 3. CRIAÇÃO DE CARD (REUTILIZÁVEL)
// ============================================================================
function createCard(pessoa, cargo) {
    ...
    nameEl.innerText = pessoa.nome.replace(/\s*\((Dia|Noite)\)/i, '');
    ...
    card.addEventListener('click', () => openModal(pessoa, cargo));
